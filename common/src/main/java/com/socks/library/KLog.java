...
public final class KLog {
    ...
    public static void d(String tag, Object... objects) {
        if (objects == null || objects.length == 0) {
            printLog(D, null, tag);//在Kolin中，i(Object msg) 会调用到i(String tag, Object... objects)
        } else {
    ...
    public static void i(String tag, Object... objects) {
        if (objects == null || objects.length == 0) {
            printLog(I, null, tag);//在Kolin中，i(Object msg) 会调用到i(String tag, Object... objects)
        } else {
    ...
    public static void e(String tag, Object... objects) {
        if (objects == null || objects.length == 0) {
            printLog(E, null, tag);//在Kolin中，i(Object msg) 会调用到i(String tag, Object... objects)
        } else {
...
//        BaseLog.printDefault(D, tag, headString + msg);
        ...
        if (objects == null || objects.length == 0) {
            String[] contents = wrapperContent(STACK_TRACE_INDEX_5, null, tagStr);
            String tag = contents[0];
            String msg = contents[1];
            String headString = contents[2];
            BaseLog.printDefault(D, tag, headString + msg);
